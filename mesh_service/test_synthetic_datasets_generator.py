...
from synthetic_datasets_generator import (
    load_yolo,
    femm_create_problem,
    femm_add_contour
)
...
class TestSyntheticDatasetsGenerator(unittest.TestCase):
    ...
    @patch('synthetic_datasets_generator.femm.openfemm')
    @patch('synthetic_datasets_generator.femm.newdocument')
    @patch('synthetic_datasets_generator.femm.ci_probdef')
    ...
    @patch('synthetic_datasets_generator.femm.ci_addnode')
    @patch('synthetic_datasets_generator.femm.ci_addsegment')
